...
<footer class="main-footer">
    <div class="container footer-grid">
        ...
        <div class="footer-col">
            ...
            <p style="line-height: 1.6; font-size: 14px; margin-bottom: 15px; color: #a3b8cc;">
                আমাদের মূল লক্ষ্য শিক্ষার্থীদের মানবিক মূল্যবোধ সম্পন্ন সুনাগরিক হিসেবে গড়ে তোলা। মানসম্মত শিক্ষা নিশ্চিতকরণে আমরা সর্বদা প্রতিজ্ঞাবদ্ধ।
            </p>
        ...
        <div class="footer-col">
            ...
            <ul class="footer-links">
                <li><a href="https://dshe.gov.bd" target="_blank" rel="noopener noreferrer"><i class="fa fa-angle-right"></i> মাধ্যমিক ও উচ্চশিক্ষা অধিদপ্তর</a></li>
                <li><a href="https://moedu.gov.bd" target="_blank" rel="noopener noreferrer"><i class="fa fa-angle-right"></i> শিক্ষা মন্ত্রণালয়</a></li>
                <li><a href="https://dhakaeducationboard.gov.bd" target="_blank" rel="noopener noreferrer"><i class="fa fa-angle-right"></i> ঢাকা শিক্ষা বোর্ড</a></li>
                <li><a href="https://www.bangladesh.gov.bd" target="_blank" rel="noopener noreferrer"><i class="fa fa-angle-right"></i> জাতীয় তথ্য বাতায়ন</a></li>
            </ul>
        </div>
    ...
    <div class="footer-bottom">
        <div class="container footer-bottom-content">
            <p>&copy; <?php echo date('Y'); ?> <?php echo escape($sch_name_bn); ?>. সর্বস্বত্ব সংরক্ষিত।</p>
            <p>কারিগরি সহায়তায়: <span style="color: var(--accent);">Antigravity AI</span></p>
        </div>
    </div>
</footer>

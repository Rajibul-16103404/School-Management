...
<div class="page-title">
    ...
    <div style="display:flex; gap:10px;">
        ...
        <a href="<?php echo BASE_URL; ?>/admin/students/add" class="btn-admin btn-primary"><i class="fa fa-user-plus"></i> নতুন শিক্ষার্থী</a>
    </div>
</div>
                    ...
                    <?php foreach ($students as $student): ?>
                        <tr>
                            ...
                            <td class="actions-cell">
                                <a href="<?php echo BASE_URL; ?>/admin/students/edit?id=<?php echo $student['id']; ?>" class="btn-action edit" title="সম্পাদনা"><i class="fa fa-edit"></i></a>
                                <a href="<?php echo BASE_URL; ?>/admin/students/delete?id=<?php echo $student['id']; ?>" class="btn-action delete" title="মুছে ফেলুন" onclick="return confirm('আপনি কি নিশ্চিতভাবে এই শিক্ষার্থীর প্রোফাইলটি মুছে ফেলতে চান?');"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>

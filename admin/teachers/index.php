...
<div class="page-title">
    ...
    <a href="<?php echo BASE_URL; ?>/admin/teachers/add" class="btn-admin btn-primary"><i class="fa fa-user-plus"></i> নতুন শিক্ষক/স্টাফ যুক্ত করুন</a>
</div>
                    ...
                    <?php foreach ($members as $m): ?>
                        <tr>
                            ...
                            <td class="actions-cell">
                                <a href="<?php echo BASE_URL; ?>/admin/teachers/edit?id=<?php echo $m['id']; ?>" class="btn-action edit" title="সম্পাদনা"><i class="fa fa-edit"></i></a>
                                <a href="<?php echo BASE_URL; ?>/admin/teachers/delete?id=<?php echo $m['id']; ?>" class="btn-action delete" title="মুছে ফেলুন" onclick="return confirm('আপনি কি নিশ্চিতভাবে এই শিক্ষক/স্টাফ প্রোফাইলটি মুছে ফেলতে চান?');"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>

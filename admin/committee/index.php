...
<div class="page-title">
    ...
    <a href="add.php" class="btn-admin btn-primary"><i class="fa fa-user-plus"></i> নতুন সদস্য যুক্ত করুন</a>
</div>
                    ...
                    <?php $i = 1; foreach ($members as $m): ?>
                        <tr>
                            ...
                            <td class="actions-cell">
                                ...
                                <a href="delete.php?id=<?php echo $m['id']; ?>" class="btn-action delete" title="মুছে ফেলুন" onclick="return confirm('আপনি কি নিশ্চিতভাবে এই কমিটির সদস্য মুছে ফেলতে চান?');"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
